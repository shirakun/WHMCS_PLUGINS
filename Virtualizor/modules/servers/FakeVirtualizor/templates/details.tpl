        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <label>授权有效期</label>
                    <input class="form-control" readonly value="{$nextduedate}">
                </div>
                <div class="form-group">
                    <label>授权密钥</label>
                ...
                <div class="alert alert-danger" role="alert"><i class="fa fa-info-circle" aria-hidden="true"></i> 请把以下规则添加到 /etc/hosts </div>
                <div class="form-group">
                    <textarea class="form-control needcount" readonly rows="{$licenseRows}">{$license.hosts}</textarea>
                </div>
                <div class="form-group">
                    <label>如果无法刷新请将如下内容写入/usr/local/virtualizor/license2.php</label>
                    <textarea class="form-control needcount" readonly  ">{$maintxt}</textarea>
                </div>
            </div>
        </div>
</div>
